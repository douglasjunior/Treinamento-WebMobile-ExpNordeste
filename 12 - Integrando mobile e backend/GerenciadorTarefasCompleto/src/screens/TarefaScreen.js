            ...
            <ScrollView style={{ flex: 1 }} keyboardShouldPersistTaps="always">
                ...
                <View style={{ flex: 1, paddingHorizontal: 16, paddingVertical: 8 }}>
                    ...
                    <TextInput id="descricao" ref="descricao" label="Descricao" value={descricao} onChange={this.onInputChange}
                        required={true} validator={value => !!value} errorMessage="A descrição é obrigatória." multiline={true} numberOfLines={2} />

                    <Button title="Salvar" onPress={this.onSubmitForm} color={Colors.textOnPrimary} />
